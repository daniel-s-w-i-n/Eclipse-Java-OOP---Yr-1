	...
	public void update() {
				...
				if (finished == true){
					...
					if (amountB>amountW)
						...
						view.feedbackToUser(1, "White won. White " +amountB +" to Black "+amountW+". Reset the game to replay.");
						view.feedbackToUser(2, "White won. White " +amountB +" to Black "+amountW+". Reset the game to replay.");
						}
					...
					{
						view.feedbackToUser(1, "Black won. Black " +amountW +" to White "+amountB+". Reset the game to replay.");
						view.feedbackToUser(2, "Black won. Black " +amountW +" to White "+amountB+". Reset the game to replay.");
					}
